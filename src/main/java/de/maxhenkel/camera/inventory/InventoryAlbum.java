...
public class InventoryAlbum implements IInventory {
    ...
    public InventoryAlbum(ItemStack album) {
        ...
        NBTTagCompound c = album.getTagCompound();

        if (c != null && c.hasKey("Images")) {
            inventoryTag = c.getCompoundTag("Images");
    ...
    public void markDirty() {
        if (inventoryTag == null) {
            ...
            if (tag == null) {
                album.setTagCompound(new NBTTagCompound());
                tag = album.getTagCompound();
            }
