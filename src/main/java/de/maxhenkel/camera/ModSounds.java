...
public class ModSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> TAKE_IMAGE = SOUND_REGISTER.register("take_image", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(CameraMod.MODID, "take_image")));
